...
class NumberToSpokenTxtIt:
    def __init__(self):
        self.cientos=[""," ", " duzentos", " trezentos", " quatrocentos" ," quinhentos", " seiscentos" ," setecentos", " oitocentos", " novecentos", \
                'dieci',' undici',' dodici',' tredici',' quattordici',' quindici',' sedici',' diciasette',' diciotto',' diciannove' ]; # 
        self.ones=["",' uno',' due',' tre',' quattro',' cinque',' sei',' sette',' otto',' nove', \
                'dieci',' undici',' dodici',' tredici',' quattordici',' quindici',' sedici',' diciasette',' diciotto',' diciannove' ]; # 
        self.ones1=["",' uno',' due',' tre',' quattro',' cinque',' sei',' sette',' otto',' nove', \
                'dieci',' undici',' dodici',' tredici',' quattordici',' quindici',' sedici',' diciasette',' diciotto',' diciannove' ]; # 
        self.suffix=["", ' uno',' due',' tre',' quattro',' cinque',' sei',' sette',' otto',' nove' ];
        self.vsuffix=["",' uno',' due',' tre',' quattro',' cinque',' sei',' sette',' otto',' nove' ];
        self.tens=["", "", ' venti',' trenta',' quaranta',' cinquanta',' sessanta',' settanta',' ottanta',' novanta' ];
        self.miles=[ "", " mille"];
        self.llones=[ "",  " milione", " miliardo", " trilione", " quadrilione", " quintilione" ];
        self.llones1=[ "",  " milione", " miliardo", " trilione", " quadrilione", " quintilione" ];
