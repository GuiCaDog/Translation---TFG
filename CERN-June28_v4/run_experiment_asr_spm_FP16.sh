...
qsubmit -n t$RUN$CORPUS -w bin$RUN$CORPUS -gmem $GPU_MEM -gcards 1 -m 30 -a punxo,pinxo,panxo.dsic.upv.es,raimonet,gozer1,gozer2,estelles ./train_model_"$TOOLKIT"_"$MODEL_CONFIG"_FP16.sh
